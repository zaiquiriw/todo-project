...
const deleteTodo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log("DELETE: " + (deletedTodo === null || deletedTodo === void 0 ? void 0 : deletedTodo.name) + " " + (deletedTodo === null || deletedTodo === void 0 ? void 0 : deletedTodo.description) + " " + (deletedTodo === null || deletedTodo === void 0 ? void 0 : deletedTodo.status));
        const allTodos = yield todo_1.default.find();
        res.status(200).json({
